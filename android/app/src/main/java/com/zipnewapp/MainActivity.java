...
public class MainActivity extends NavigationActivity {
  ...
  // public class MainActivity extends SplashActivity implements
  ...
  // Typeface tf1 =Typeface.createFromAsset(mgr,
  // "fonts/Avenir-Medium.ttf");//根据路径得到Typeface
  ...
  // // SpannableStringBuilder sb = new SpannableStringBuilder("Package receiving
  // becomes so easy and safe!"); // 包装字体内容
  // // ForegroundColorSpan fcs = new
  // ForegroundColorSpan(Color.parseColor("#333333")); // 设置字体颜色
