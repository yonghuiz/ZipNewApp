...
//  zipcodeXpress
//
//  Created by Lin Yang on 2017/12/27.
...
RCT_EXPORT_MODULE(DeviceInfoManager)
...
- (NSString *)deviceName {
  static NSMutableDictionary * deviceNameByCode = nil;
  if (!deviceNameByCode) {
    deviceNameByCode = @{
  ...
  NSString *deviceName = [deviceNameByCode objectForKey:self.deviceId];
  if (!deviceName) {
