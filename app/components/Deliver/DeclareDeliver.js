    ...
    return (
      <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            {this.state.images === null ? (
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
                ...
                <ZIPText style={{marginTop: 8}}>Upload package photo</ZIPText>
              </View>
            ) : (
              <Image
            ...
            {this.state.images === null ? null : (
              <View
                ...
                <ZIPText style={{color: 'white'}}>First image</ZIPText>
              </View>
            )}
          </TouchableOpacity>
          <ZIPTextInput
        ...
        <TouchableOpacity
          ...
          <ZIPText style={{color: 'white', fontSize: 16}}>Submit</ZIPText>
        </TouchableOpacity>
